  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      ...
      <div class="row center">
        <h1 class="header col s12 light">please click on the link below to verify your email address!!</h1>
      ...
      <div class="row center">
        ...
        <a href="#openModal" id="download-button" class="btn-large waves-effect waves-light orange">Verify</a>
