        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2" >
            <div class="panel panel-info" style="background:none;border:none;"  >
                    <div class="panel-heading" style="background:none;">
                        <div class="panel-title" ><h3 style="color:white;">Sign In</h3></div>
...
<br>
<div class="col-md-11">
<a href="/login/fb" class="btn btn-block btn-social btn-google">
<i class="fa fa-google"></i> Sign in with Google
                                ...
                                <div>
                                  ...
                                  <h5><p style="color:white;">          Don't have an account!</p><h5>
                                        <a href="#" onClick="$('#loginbox').hide(); $('#signupbox').show()">
                                        <h5><p style="color:white;">       Sign Up Here</p></h5>
                                        </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form id="signupform" data-toggle="validator" class="form-horizontal" method="post" role="form" action="{{url('auth/register')}}" >
                                ...
                                <div style="border-top: 1px solid #999; padding-top:20px"  class="form-group">
                                    ...
                                    <div class=" col-md-6 text-center">
                                      <a href="/login/fb">  <button id="btn-fbsignup" style="background:#3b5998;" type="button" class="btn btn-primary"><i class="icon-facebook"></i>   Sign Up with Facebook</button></a>
                                    </div>
                                    <div class=" col-md-6 text-center">
                                      <a href="/login/fb">  <button id="btn-fbsignup" style="background:#F90101" type="button" class="btn btn-primary"><i class="icon-facebook"></i>   Sign Up with Google</button></a>
                                    </div>
